...
extern void cmd_animation_define(CommandContext context);
extern void cmd_animation_define_speed(CommandContext context);
extern void cmd_animation_define_looping(CommandContext context);
extern void cmd_animation_define_hanging(CommandContext context);
extern void cmd_animation_define_store(CommandContext context);
extern void cmd_animation_play(CommandContext context);
extern void cmd_animation_play_register(CommandContext context);
