...
extern const Command commands[] = { CMD_LITERALS(),
    ...
    CMD_LITERAL("camera"),
        CMD_LITERALS(),
            CMD_LITERAL("freeze"),
                CMD_EXEC(cmd_camera_freeze),
            CMD_END(),
            CMD_LITERAL("unfreeze"),
                CMD_EXEC(cmd_camera_unfreeze),
            CMD_END(),
            CMD_LITERAL("pos"),
                CMD_ARG_ARR("operation", "add\0set\0"),
                CMD_ARG_FLT("x"),
    ...
    CMD_LITERAL("timeline"),
        ...
        CMD_LITERALS(),
            ...
            CMD_END(),
            CMD_LITERAL("curve"),
                CMD_ARG_ARR("type", "linear\0start_slow\0start_fast\0smooth\0hold\0"),
    ...
    CMD_LITERAL("animation"),
        CMD_LITERALS(),
            CMD_LITERAL("play"),
                CMD_ARG_ARR("custom", "vanilla\0custom\0"),
                CMD_ARG_STR("anim"),
                CMD_EXEC(cmd_animation),
                CMD_ARG_FLT("speed"),
                CMD_EXEC(cmd_animation_speed),
                CMD_LITERALS(),
                    CMD_LITERAL("looping"),
                        CMD_EXEC(cmd_animation_looping),
                    CMD_END(),
                    CMD_LITERAL("hanging"),
                        CMD_EXEC(cmd_animation_hanging),
                    CMD_END(),
                CMD_END(),
            CMD_END(),
            CMD_LITERAL("stop"),
