...
void saturn_project_game_handler(SaturnFormatStream* stream, int version) {
    ...
    configDustParticles = flags & SATURN_PROJECT_FLAG_DUST_PARTICLES;
    ...
    configShadows = flags & SATURN_PROJECT_FLAG_SHADOWS;
...
void saturn_save_project(char* filename) {
    ...
    if (configDustParticles) flags |= SATURN_PROJECT_FLAG_DUST_PARTICLES;
    ...
    if (configShadows) flags |= SATURN_PROJECT_FLAG_SHADOWS;
