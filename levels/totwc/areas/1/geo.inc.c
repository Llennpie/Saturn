   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_LEVEL_DISPLAY_LIST(LAYER_OPAQUE, totwc_seg7_dl_07005D28),
               GEO_LEVEL_DISPLAY_LIST(LAYER_TRANSPARENT, totwc_seg7_dl_07007048),
               GEO_LEVEL_DISPLAY_LIST(LAYER_TRANSPARENT, totwc_seg7_dl_070078B8),
               GEO_RENDER_OBJ(),
