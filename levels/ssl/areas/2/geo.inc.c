   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_LEVEL_DISPLAY_LIST(LAYER_OPAQUE, ssl_seg7_dl_0701EE80),
               GEO_LEVEL_DISPLAY_LIST(LAYER_ALPHA, ssl_seg7_dl_0701F920),
               GEO_LEVEL_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, ssl_seg7_dl_0701FCE0),
