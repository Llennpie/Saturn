   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_LEVEL_DISPLAY_LIST(LAYER_OPAQUE, ssl_seg7_dl_07009F48),
               GEO_LEVEL_DISPLAY_LIST(LAYER_OPAQUE, ssl_seg7_dl_0700BA78),
               GEO_LEVEL_DISPLAY_LIST(LAYER_ALPHA, ssl_seg7_dl_0700BC18),
               GEO_LEVEL_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, ssl_seg7_dl_0700BD00),
