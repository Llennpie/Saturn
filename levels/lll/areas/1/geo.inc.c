   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_LEVEL_DISPLAY_LIST(LAYER_OPAQUE, lll_seg7_dl_070134E0),
               GEO_LEVEL_DISPLAY_LIST(LAYER_ALPHA, lll_seg7_dl_070138F8),
               GEO_LEVEL_DISPLAY_LIST(LAYER_ALPHA, lll_seg7_dl_070137C0),
