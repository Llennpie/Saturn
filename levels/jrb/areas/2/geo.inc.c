   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_LEVEL_DISPLAY_LIST(LAYER_OPAQUE, jrb_seg7_dl_0700EF00),
               GEO_LEVEL_DISPLAY_LIST(LAYER_ALPHA, jrb_seg7_dl_0700FE48),
               GEO_LEVEL_DISPLAY_LIST(LAYER_OPAQUE, jrb_seg7_dl_07010548),
