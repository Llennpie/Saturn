   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_LEVEL_DISPLAY_LIST(LAYER_OPAQUE, wdw_seg7_dl_07009AB0),
               GEO_LEVEL_DISPLAY_LIST(LAYER_ALPHA, wdw_seg7_dl_0700A138),
               GEO_LEVEL_DISPLAY_LIST(LAYER_TRANSPARENT, wdw_seg7_dl_07012798),
