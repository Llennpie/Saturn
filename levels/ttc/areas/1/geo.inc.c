      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_LEVEL_DISPLAY_LIST(LAYER_OPAQUE, ttc_seg7_dl_0700AD38),
               GEO_LEVEL_DISPLAY_LIST(LAYER_TRANSPARENT, ttc_seg7_dl_0700B1D8),
               GEO_LEVEL_DISPLAY_LIST(LAYER_ALPHA, ttc_seg7_dl_0700E878),
               GEO_RENDER_OBJ(),
