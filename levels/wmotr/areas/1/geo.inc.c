   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_LEVEL_DISPLAY_LIST(LAYER_OPAQUE, wmotr_seg7_dl_0700C1F8),
               GEO_LEVEL_DISPLAY_LIST(LAYER_TRANSPARENT, wmotr_seg7_dl_0700EFD8),
               GEO_LEVEL_DISPLAY_LIST(LAYER_TRANSPARENT, wmotr_seg7_dl_07010608),
               GEO_RENDER_OBJ(),
